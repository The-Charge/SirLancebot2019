...
public class OI {
    ...
    public SendableChooser driveControl;
	...
	public OI() {
        ...
        driveControl = new SendableChooser();
		driveControl.addDefault("Traditional", 3);
        driveControl.addObject("Xbox Control", 1);
        ...
        if (driveControl.getSelected().equals(1))
        {
            ...
            //FIGURE OUT THESE
            shooterDownButton = new JoystickButton(xbox, 1);
            shooterDownButton.whenPressed(new LowerShooter());
            shooterUpButton = new JoystickButton(xbox, 9);
            shooterUpButton.whenPressed(new LiftShooter());
          
            armsDownButton = new JoystickButton(xbox, 2);
            armsDownButton.whenPressed(new LowerArms());
            armsUpButton = new JoystickButton(xbox, 7);
            armsUpButton.whenPressed(new LiftArms());
          
            wristDownButton = new JoystickButton(xbox, 12);
            wristDownButton.whenPressed(new WristDown());        
            wristUpButton = new JoystickButton(xbox, 11);
